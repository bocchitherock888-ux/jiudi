...
视频功能首次运行时下载的 @ffmpeg/core 0.12.6 含 GPL 组件，遵循其上游许可。该核心由上游按需提供，发布压缩包内包含 JavaScript API 和相关许可说明。重新分发核心文件时，应核实相应源码及适用的许可要求；目前精确对应源码的核验范围见第三方说明。

本项目提供运行源码、分发包、使用说明和许可文件。MIT 适用于就地原创部分，第三方部分按各自许可使用。
